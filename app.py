...
img_name = st.sidebar.selectbox("Select image", ('R2(Basal like)','R4(ER+)','R5(HER2+)'))
...
epi_marker = st.sidebar.selectbox("Select epithelial marker label", adata.obs.columns)
